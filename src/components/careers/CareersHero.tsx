  ...
  return (
    <section className="relative bg-primary pt-32 pb-20 md:pt-40 md:pb-28 px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        <div
          className="absolute inset-0 bg-gradient-to-br from-consulting-accent/20 via-transparent to-academia/10 animate-pulse"
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(hsl(var(--consulting-accent)) 1px, transparent 1px), linear-gradient(90deg, hsl(var(--consulting-accent)) 1px, transparent 1px)",
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <p className="mt-6 text-lg text-white/70 max-w-2xl leading-relaxed">
            We are hiring across AI, Data, Cybersecurity, Cloud, Engineering and Digital Transformation domains aligned
            to global capability center (GCC) demand.
          </p>

          <div className="flex flex-wrap gap-4 mt-8 text-consulting-accent">
            <Button onClick={scrollToPositions} size="lg" className="btn-consulting gap-2">
              View Open Roles <ArrowDown size={16} />
            </Button>
            <Button asChild size="lg" variant="outline" className="border-white/20 text-amber-600 hover:bg-white/10">
